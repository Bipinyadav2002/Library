<aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="{{route('admin.issued.books')}}"><i class="bi bi-circle"></i>Issued Book List</a>
                </li>
                <li> <a href="{{route('admin.available.books')}}"><i class="bi bi-circle"></i>Available Books</a>
                </li>
